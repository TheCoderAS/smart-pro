...
mixin _$FirmwareManifest {
 ...
 int get type; String get version; int get sec; int get size; String get sig; String get url;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,version,sec,size,sig,url);

@override
String toString() {
  return 'FirmwareManifest(type: $type, version: $version, sec: $sec, size: $size, sig: $sig, url: $url)';
}
...
@useResult
$Res call({
 int type, String version, int sec, int size, String sig, String url
});
...
/// Create a copy of FirmwareManifest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? version = null,Object? sec = null,Object? size = null,Object? sig = null,Object? url = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int type,  String version,  int sec,  int size,  String sig,  String url)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FirmwareManifest() when $default != null:
return $default(_that.type,_that.version,_that.sec,_that.size,_that.sig,_that.url);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int type,  String version,  int sec,  int size,  String sig,  String url)  $default,) {final _that = this;
switch (_that) {
case _FirmwareManifest():
return $default(_that.type,_that.version,_that.sec,_that.size,_that.sig,_that.url);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int type,  String version,  int sec,  int size,  String sig,  String url)?  $default,) {final _that = this;
switch (_that) {
case _FirmwareManifest() when $default != null:
return $default(_that.type,_that.version,_that.sec,_that.size,_that.sig,_that.url);case _:
  return null;
...
class _FirmwareManifest implements FirmwareManifest {
  const _FirmwareManifest({required this.type, required this.version, this.sec = 0, this.size = 0, this.sig = '', this.url = ''});
...
/// Create a copy of FirmwareManifest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? type = null,Object? version = null,Object? sec = null,Object? size = null,Object? sig = null,Object? url = null,}) {
...
mixin _$StoredImage {
 ...
 int get type; String get version; int get size;
...
@useResult
$Res call({
 int type, String version, int size
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int type,  String version,  int size)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StoredImage() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int type,  String version,  int size)  $default,) {final _that = this;
switch (_that) {
case _StoredImage():
return $default(_that.type,_that.version,_that.size);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int type,  String version,  int size)?  $default,) {final _that = this;
switch (_that) {
case _StoredImage() when $default != null:
return $default(_that.type,_that.version,_that.size);case _:
  return null;
...
class _StoredImage implements StoredImage {
  const _StoredImage({this.type = 0, this.version = '', this.size = 0});
